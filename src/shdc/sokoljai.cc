            ...
            if (inp.ctype_map.count(uniform_type_str(uniform.type)) > 0) {
                ...
                if (uniform.array_count == 1) {
                    switch (uniform.type) {
                        ...
                        case uniform_t::FLOAT2:  L("    {}: [2]float32,\n", uniform.name); break;
                        case uniform_t::FLOAT3:  L("    {}: [3]float32,\n", uniform.name); break;
                        case uniform_t::FLOAT4:  L("    {}: [4]float32,\n", uniform.name); break;
                        case uniform_t::INT:     L("    {}: s32,\n", uniform.name); break;
                        case uniform_t::INT2:    L("    {}: [2]s32,\n", uniform.name); break;
                        case uniform_t::INT3:    L("    {}: [3]s32,\n", uniform.name); break;
                        case uniform_t::INT4:    L("    {}: [4]s32,\n", uniform.name); break;
                        case uniform_t::MAT4:    L("    {}: [16]float32,\n", uniform.name); break;
...
errmsg_t sokoljai_t::gen(const args_t& args, const input_t& inp,
